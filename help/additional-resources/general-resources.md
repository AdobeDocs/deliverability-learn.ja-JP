---
title: その他のリソース
description: この節では、配信品質に関するその他のリソースの一覧を示します。
...
配信品質に関する最近のアップデートについて詳しくは、次のテクニカルノートを参照してください。

* [Gmailのメッセージ識別（BIMI）のためのブランド指標の実装](../technotes/implement-bimi.md)

## 汎用リソース

このセクションでは、特定の推奨事項やベストプラクティス、その他のツール、トラブルシューティング手順など、配信品質に関するその他のリソースを紹介します。
...
さらに、ここでは、Adobeソリューションの配信品質を向上し、成功に導くための製品固有のリソースを紹介します。

**[!DNL Adobe Campaign]**

* [ドメイン名の設定](../../help/additional-resources/ac-domain-name-setup.md)
* [CSRとSSL証明書の要求プロセス](../../help/additional-resources/ac-ssl-certificate-request.md)
